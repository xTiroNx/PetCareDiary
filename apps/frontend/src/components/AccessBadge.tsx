...
export function AccessBadge() {
  ...
  const label = status === "admin" ? t("adminAccess") : status === "lifetime" ? t("lifetime") : status === "active_monthly" ? t("monthlyActive") : status === "trial" ? t("trialDays", { days: daysLeft ?? 0 }) : t("freeAccess");
