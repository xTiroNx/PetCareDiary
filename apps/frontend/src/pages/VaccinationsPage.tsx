...
export default function VaccinationsPage() {
  ...
  const add = useMutation<VaccinationEntry, Error, Record<string, unknown>>({
    mutationFn: (body) => api<VaccinationEntry>("/api/vaccinations", { method: "POST", body: jsonBody(body) }),
